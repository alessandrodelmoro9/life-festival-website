...
export const speakersData: Speaker[] = [
  ...
  },
  {
    ...
    description: "Marco Zamberlan è graphic designer in Cosmico, dove si occupa della progettazione grafica dell'intero gruppo, dalla comunicazione digitale ai progetti editoriali, dal merchandise agli eventi. Classe '96, scorpione ascendente sagittario, si laurea in Product & Service Design e da (quasi) 2 anni lavora in Cosmico con la stessa curiosità con cui da bambino smontava (e a volte rimontava) i suoi giocattoli preferiti per capire come funzionavano.\n\nNerd incallito, amante della cultura pop, entusiasta per natura e quasi sempre con il cappellino in testa.",
    color: 'accent',
  ...
  },
  {
    ...
    description: "Riccardo Albertini, Fondatore e Direttore Creativo di Rocketpanda, nutre una profonda passione per il design, l’animazione e la motion graphics. È un orgoglioso padre di tre figli, possiede un paio di sintetizzatori e nel tempo libero ama suonare e comporre musica. Imparare a semplificare non è una rinuncia, ma il traguardo di anni di sano caos.",
    color: 'primary',
